...
public class Rectangle{
    ...
    /**
     * Change the colors. 
     * @param colors the new colors. Valid colors are the parameters like {"yellow","blue","red"}
     */
    ...
    /**
     * change the area.
     * @param (+ or -) to have another area, the change is with 10% more or less
     */
    public void zoom(char c){
       
        if (c=='+'){
            height = ((height*10)/100)+height;
            ...
            System.out.println("Digite unicamente + o -");
        }
        draw();
    }
    /*
