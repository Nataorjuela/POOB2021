...
public class Sinap{
    ...
    public void adicioneCinco()throws SINAPExcepcion{
            ...
            new Area("Tuparro","Tuparro National Park","Vichada","548.000","Es una extensa sabana verde surcada por grandes ríos con potentes raudales y playas doradas, pequeños"+
    ...
    public void adicione(String nombre, String name,String ubicacion, String area, String descripcion)throws SINAPExcepcion{
        ...
        if(name.equals("")){       
            throw new SINAPExcepcion(SINAPExcepcion.SIN_NOMBRE_INTERNACIONAL);
        }
        int areaint=Integer.parseInt(area);
        if(areaint<=0){
        	throw new SINAPExcepcion(SINAPExcepcion.AREA_ERRONEA);
        }
        else
    ...
    public void adicioneDetalles(Area detalles)throws SINAPExcepcion{
    	int i=0;
            ...
            for(Area j:areas){
                if(j.getNombre().equals(detalles.getNombre())){
     ...
     */
    public ArrayList<Area> busque(String prefijo) throws SINAPExcepcion{
        ArrayList<Area> resultados=null;
        boolean flag = false;
        if(resultados == null) {
            flag = true;
            throw new SINAPExcepcion(SINAPExcepcion.HUBO_UN_ERROR);
        }
