...
public class SinapGUI extends JFrame{
   ...
   /**
    ...
    private void  accionAdicionar(){
        ...
        catch(SINAPExcepcion e){JOptionPane.showMessageDialog(null,e.getMessage(),"ERROR",JOptionPane.ERROR_MESSAGE);}
    }

    private void accionBuscar() throws SINAPExcepcion{
